    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (empty($formErrors)) {
                ...
                $stmt = $db->prepare("INSERT INTO items( Name, Description, Price, Date, Country_Made, Status, Category_ID, User_ID, tags) 

                                            VALUES(:iname, :idesc, :iprice, now(), :icountry, :istat, :icatid, :iuserid, :itags ) ");
