    ...
    if(isset($_SESSION["user"])) {
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if(empty($formErrors)) {                    
                ...
                $stmt = $db->prepare("INSERT INTO items( Name, Description, Price, Date, Country_Made, Status, Category_ID, tags, User_ID) 

                                        VALUES(:iname, :idesc, :iprice, now(), :icountry, :istat, :icatid, :itag, :iuserid ) ");
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <form class="form-horizontal adsform" action="<?php echo $_SERVER["PHP_SELF"] ?>" method="POST">
